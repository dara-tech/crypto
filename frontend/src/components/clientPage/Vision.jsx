          ...
          <div className="max-w-4xl mx-auto">
            {company?.logo && (
              <img
                ...
                className="w-28 h-28 object-contain mb-6 mx-auto bg-white/10 p-2 rounded-full"
              />
            )}
            <h1 className="text-5xl md:text-6xl font-bold mb-6 text-center">{company?.name}</h1>
