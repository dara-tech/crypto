  ...
  return (
    <div className="flex flex-col bg-gradient-to-b from-base-200/50 to-base-100">
      ...
      <div className="relative h-[600px] w-full overflow-hidden">
        {company?.aboutImage ? (
          <img src={company.aboutImage} alt="About Banner" className="w-full h-full object-cover" />
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 to-black/40 flex flex-col items-center justify-center text-white px-6 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6 text-center">About {company?.name}</h1>
            <p className="text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed">{company?.about}</p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
          {/* Mission Card */}
          <Link to="/mission" className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden">
            <figure className="relative h-72">
              {company?.missionImage ? (
                <img src={company.missionImage} alt="Mission" className="w-full h-full object-cover" />
              ) : (
            ...
            <div className="card-body">
              <h3 className="card-title text-2xl font-bold">Our Mission</h3>
